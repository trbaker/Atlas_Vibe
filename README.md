  ...
  <div class="cards-grid">
    <div class="card">
      ...
      <div style="margin-top:1rem;display:flex;flex-direction:column;gap:0.5rem;">
        ...
        <a href="https://github.com/trbaker/Atlas_Vibe/blob/main/mapmaker-gallery.html" target="_blank" class="proj-btn proj-code">📄 View Code on GitHub</a>
      </div>
    </div>
    <div class="card">
      ...
      <div style="margin-top:1rem;display:flex;flex-direction:column;gap:0.5rem;">
        ...
        <a href="https://github.com/trbaker/Atlas_Vibe/blob/main/mapmaker-tagger.html" target="_blank" class="proj-btn proj-code">📄 View Code on GitHub</a>
      </div>
    </div>
  </div>
